    ...
    return (
      <Html lang="en">
        <Head>
          ...
          { /* OG TAGS */ }
          <meta property="og:title" content="MindScan is a tool for inspecting and analyzing the Mind Smart Chain.."/>
          <meta
            property="og:description"
            // eslint-disable-next-line max-len
            content="MindScan is a tool for inspecting and analyzing the Mind Smart Chain."
          />
          <meta property="og:image" content={ config.app.baseUrl + '/static/thumb.jpg' }/>
          <meta property="og:site_name" content="Blockscout"/>
          <meta property="og:type" content="website"/>
          <meta name="twitter:card" content="summary_large_image"/>
          <meta property="twitter:image" content={ config.app.baseUrl + '/static/thumb.jpg' }/>
        </Head>
        <body>
